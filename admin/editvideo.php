    ...
    <div class="content-wrapper ">
      ...
      <div class="card card-primary col-lg-12">
       ...
       <?php
        ...
        //   print_r($_POST);
          $id = $_POST['editid'];
          $query = "SELECT * from home_video where id = $id";
          $run = mysqli_query($db, $query);
           ...
           <form action="../include/admin.php" method="POST" enctype="multipart/form-data">
             <div class="card-body">
               ...
               <div class="form-group">
                 ...
                 <input type="text" name="npicEdit" value="<?=$rp = str_replace("watch?v=","embed/",$data['url']);?>" class="form-control">
               </div>
             </div>
             <div class="card-footer">
               <a href="index.php" class="btn btn-danger">Cancel</a>
               <button type="submit" name="update-video" class="btn btn-success">Save Changes</button>
