           ...
           <form action="../include/admin.php" method="POST" enctype="multipart/form-data">
             <div class="card-body">
               ...
               <div class="form-group">
                 ...
                 <input type="file" name="epicEdit" value="<?= $data['epic'] ?>" class="form-control">
               </div>

               <div class="form-group">
                 <label for="exampleInputEmail1">Description</label>
                 <input type="text" name="edescEdit" value="<?= $data['edesc'] ?>" class="form-control ">
               </div>

             </div>
             <div class="card-footer">
               <a href="index.php" class="btn btn-danger">Cancel</a>
               <button type="submit" name="update-event" class="btn btn-success">Save Changes</button>
