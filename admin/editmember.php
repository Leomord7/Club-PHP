...
$query = "SELECT * FROM membership_registrations";
...
<div class="card custom-card col-lg-12">
    ...
    if (isset($_POST['editid'])) {
        ...
        $query = "SELECT * FROM membership_registrations WHERE id='$id'";
        $run = mysqli_query($conn, $query);
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" name="package_name" required>
                        <option value="Gold" <?= ($data['package_name']=='Gold')?'selected':''; ?>>Gold</option>
                        <option value="Premium" <?= ($data['package_name']=='Premium')?'selected':''; ?>>Premium</option>
                        <option value="Premium Plus" <?= ($data['package_name']=='Premium Plus')?'selected':''; ?>>Premium Plus</option>
                    </select>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-control" name="membership_type">
                        <option value="Annual"
                            <?= ($data['membership_type']=='Annual')?'selected':''; ?>>
                            Annual
                        </option>
                    </select>
                </div>
