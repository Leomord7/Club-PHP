      ...
      <div class="card card-primary col-lg-12">
       ...
       <?php
        if (isset($_POST['editnews'])) {
          ...
          print_r($_POST);
          $id = $_POST['editid'];
          $query = "SELECT * from home_gallery where id = $id";
          $run = mysqli_query($db, $query);
             ...
             <div class="card-body">
               ...
               <div class="form-group col-6">
                 ...
                 <select name="type" class="form-control">
                   ...
                   <option value="bhumi">h</option>
                   <option value="work">मुख्यविकास कामे</option>
                   <option value="photo">कॉलनीतील विकास</option>
                   <option value="event">स्वच्छता विषयक</option>




                   <option value="event">विद्युत विषयक</option>
                   <option value="campaign">पाणी विषयक</option>
                   <option value="speech">सुशोभीकरण विषयक</option>
                   <option value="vote">क्रीडा व शाळे विषयक</option>



                   <option value="bhumipoojan">रेल्वे अंडरपास विषयक</option>
                   <option value="event">पावसाळी लाईन विषयक</option>
                   <option value="event">कोरोना विषयक</option>
                   <option value="speech">बातमी</option>

                   <option value="campaign">जाहिरात</option>
                   <option value="photo">छायाचित्र</option>
                   <option value="yojana">योजना</option>
                   <option value="vote">व्हिडिओ</option>
                   <option value="vote">प्रस्तावित विषयक</option>
               ...
               <div class="form-group">
                 ...
                 <input type="file" name="npicEdit" value="<?= $data['gpic'] ?>" class="form-control">
               </div>
             </div>
             <div class="card-footer">
               <a href="index.php" class="btn btn-danger">Cancel</a>
               <button type="submit" name="update-gallery" class="btn btn-primary">Save Changes</button>
