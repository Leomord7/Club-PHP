      ...
      <div class="card card-primary col-lg-12">
       ...
       <?php
        if (isset($_POST['editnews'])) {
          ...
          print_r($_POST);
          $id = $_POST['editid'];
          $query = "SELECT * from work_news where id = $id";
          $run = mysqli_query($db, $query);
           ...
           <form action="../include/admin.php" method="POST" enctype="multipart/form-data">
             <div class="card-body">
               ...
               <div class="form-group">
                 ...
                 <input type="file" name="npicEdit" value="<?= $data['npic'] ?>" class="form-control">
               </div>
             </div>
             <div class="card-footer">
               <a href="index.php" class="btn btn-danger">Cancel</a>
               <button type="submit" name="update-news" class="btn btn-primary">Save Changes</button>
