        ...
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-5 px-5 text-end">
                ...
                <div class="h-100 d-inline-flex align-items-center mx-n2">
                    ...
                    <a class="btn btn-square btn-link rounded-0 border-0 border-end border-secondary" href="<?= $setting['linkedin']; ?>"><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn btn-square btn-link rounded-0" href="<?= $setting['instagram']; ?>"><i class="fab fa-instagram"></i></a>
